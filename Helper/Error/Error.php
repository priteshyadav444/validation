...
class ErrorHandle
{
    ...
    public function errorHandler($errorCode, $dataTypes = null, $key = "", $return = false, $meta = null)
    {
        $errorMessage = match ($errorCode) {
            ...
            'INVALID_DATATYPE_ALPHANUMERIC' => "$key must be Alpha Numeric",
            'INVALID_DATATYPE_DATE' => "Invalid date Formet",
    ...
    public function getErrorMessage($validationType, $key, $dataTypes = null, $meta = null)
    {
        $errorCode = match ($validationType) {
            ...
            'CHECK_ALPHA_NUMERIC' => 'INVALID_DATATYPE_ALPHANUMERIC',
            'CHECK_DATE' => 'INVALID_DATATYPE_DATE',
